...
class Settings(BaseSettings):
    ...
    default_model: str = "openrouter/deepseek/deepseek-chat-v3-0324"
    litellm_model: str = "openrouter/deepseek/deepseek-chat-v3-0324"
    litellm_api_key: str = ""
    openrouter_api_key: str = ""
    openrouter_base_url: str = "https://openrouter.ai/api/v1"
    router_agent_model: str = "openrouter/deepseek/deepseek-chat-v3-0324"
    coding_agent_model: str = "openrouter/deepseek/deepseek-chat-v3-0324"
    coding_agent_escalation_model: str = "openrouter/anthropic/claude-3.7-sonnet"
    testing_agent_model: str = "openrouter/deepseek/deepseek-chat-v3-0324"
    testing_agent_escalation_model: str = "openrouter/anthropic/claude-3.7-sonnet"
    research_agent_model: str = "openrouter/deepseek/deepseek-chat-v3-0324"
    research_agent_escalation_model: str = "openrouter/anthropic/claude-3.7-sonnet"
    planning_agent_model: str = "openrouter/deepseek/deepseek-chat-v3-0324"
    planning_agent_escalation_model: str = "openrouter/anthropic/claude-3.7-sonnet"
    server_ops_agent_model: str = "openrouter/deepseek/deepseek-chat-v3-0324"
    ...
    agent_workspaces_dir: str = "./workspaces"
    agent_allow_network_installs: bool = True
    agent_require_approval_for_installs: bool = True
    agent_shell_timeout_seconds: int = 120
    agent_loop_max_iterations: int = 30
    agent_loop_max_runtime_seconds: int = 1800
    agent_loop_max_repeated_errors: int = 3
    browser_enabled: bool = True
    source_cache_enabled: bool = True
    source_cache_dir: str = "./source-cache"
    source_cache_require_approval: bool = True
    opensrc_command: str = "opensrc"
    ripgrep_command: str = "rg"
    github_token: str = ""
    github_repository: str = ""
    github_default_branch: str = "main"
    github_bot_branch_prefix: str = "agent-sam/"
    github_auto_create_pr: bool = False
    openai_api_key: str = ""
